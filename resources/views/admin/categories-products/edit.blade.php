            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="p-2">
                                <form class="form-horizontal" role="form" method="POST" action="{{route('admin.categoryProduct.update', $category)}}">
                                    @csrf

                                    <div class="mb-2 row">
                                        <label class="col-md-2 col-form-label" for="title">عنوان</label>
                                        <div class="col-md-10">
                                            <input type="text" name="title" value="{{$category->title}}" class="form-control @error('title') is-invalid @enderror" placeholder="عنوان را وارد کنید...">
                                        </div>
                                        @error('title')
                                    ...
                                    <div class="mb-2 row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" id="slug" name="slug" class="form-control" value="{{$category->slug}}" placeholder="نشانی اینترنتی را وارد کنید...">
                                        </div>
                                        @error('slug')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                    ...
                                    <div class="mb-2 row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" name="meta_title" id="meta_title" class="form-control" value="{{$category->meta_title}}" placeholder="عنوان سئو را وارد کنید">
                                        </div>
                                        @error('meta_title')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                    ...
                                    <div class="mb-2 row">
                                        ...
                                        <div class="col-md-10">
                                            <textarea id="textarea" name="meta_description" class="form-control" maxlength="225" rows="3" placeholder="...">{{$category->meta_description}}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-2 row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" id="selectize-tags" name="meta_keyword" value="{{$category->meta_keyword}}">
                                        </div>
                                        @error('meta_keyword')
                                        <div class="invalid-feedback">
                                            {{ $message }}
