                            ...
                            <div class="p-2">
                                ...
                                <form class="form-horizontal" role="form" method="POST" action="{{route('admin.post.update', $post)}}">
                                    ...
                                    <div class="mb-2 row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" name="title" class="form-control" value="{{$post->title}}" @error('title') is-invalid @enderror" placeholder="عنوان را وارد کنید...">
                                        </div>
                                        @error('title')
                                    ...
                                    <div class="mb-2 row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" id="slug" name="slug" class="form-control" value="{{$post->slug}}" placeholder="نشانی اینترنتی را وارد کنید...">
                                        </div>
                                        @error('slug')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                    ...
                                    <div class="mb-2 row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" name="meta_title" id="meta_title" class="form-control" value="{{$post->meta_title}}" placeholder="عنوان سئو را وارد کنید">
                                        </div>
                                        @error('meta_title')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                    ...
                                    <div class="mb-2 row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" id="selectize-tags" name="meta_keyword" value="{{$post->meta_keyword}}">
                                        </div>
                                        @error('meta_keyword')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                    ...
                                    <div class="mb-2 row">
                                        ...
                                        <div class="col-md-10">
                                            <textarea id="textarea" name="meta_description" class="form-control" maxlength="225" rows="3" placeholder="...">{{$post->meta_description}}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-2 row">
                                        ...
                                        <div class="col-md-10">
                                            <textarea name="short_desc" maxlength="180" rows="3" class="form-control @error('short_desc') is-invalid @enderror" rows="4">{{$post->short_desc}}</textarea>
                                        </div>
                                        @error('short_desc')
                                        <div class="invalid-feedback">
                                            {{ $message }}
