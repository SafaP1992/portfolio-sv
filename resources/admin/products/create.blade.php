                            ...
                            <div class="p-2">
                                <form class="form-horizontal" role="form" method="POST" action="{{route('admin.product.store')}}">
                                    ...
                                    <div class="mb-2 row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" name="price" class="form-control round-input @error('price') is-invalid @enderror">
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-2 row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" name="discount_price" class="form-control round-input @error('discount_price') is-invalid @enderror">
                                        </div>
                                    </div>
